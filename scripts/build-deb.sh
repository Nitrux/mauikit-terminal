...
cmake \
	...
	-DCMAKE_INSTALL_LIBDIR=lib/x86_64-linux-gnu ../mauikit-terminal/
...
checkinstall -D -y \
	...
	--requires="libc6,libgcc-s1,libkf5coreaddons5,libkf5i18n5,libqt5core5a,libqt5gui5,libqt5qml5,libqt5widgets5,libstdc++6,mauikit-git \(\>= 2.2.1+git\),mauikit-filebrowsing-git \(\>= 2.2.1+git\)" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
